...
void Adafruit_ST7735_mod::initB(void) { commonInit(Bcmd); }
...
void Adafruit_ST7735_mod::drawFastHLine(int16_t x, int16_t y, int16_t w, uint16_t color)
{
...
void Adafruit_ST7735_mod::fillScreen(uint16_t color) { fillRect(0, 0, _width, _height, color); }


// fill a rectangle
void Adafruit_ST7735_mod::fillRect(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color)
{
...
void Adafruit_ST7735_mod::setRotation(uint8_t m)
{
    ...
    case 0:
        ...
        if (tabcolor == INITR_144GREENTAB) _height = ST7735_TFTHEIGHT_144;
        else
    ...
    case 1:
        ...
        if (tabcolor == INITR_144GREENTAB) _width = ST7735_TFTHEIGHT_144;
        else
