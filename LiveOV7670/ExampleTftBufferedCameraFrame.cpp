...
// BufferedCameraOV7670_QQVGA::FPS_5_Hz); BufferedCameraOV7670_QQVGA
// camera(CameraOV7670::PIXEL_RGB565, BufferedCameraOV7670_QQVGA::FPS_2_Hz);
...
static const uint16_t byteCountForDisplay =
    camera.getPixelBufferLength() < screen_w * 2 ? camera.getPixelBufferLength() : screen_w * 2;
...
void screenLineEnd() { tft.endAddrWindow(); }
