...
class Adafruit_ST7735_mod : public Adafruit_GFX
{
  ...
  public:
    ...
    void initB(void),                            // for ST7735B displays
        ...
        startAddrWindow(uint8_t x0, uint8_t y0, uint8_t x1, uint8_t y1), endAddrWindow(),
  ...
  private:
    ...
    uint8_t _cs, _rs, _rst, _sid, _sclk, datapinmask, clkpinmask, cspinmask, rspinmask, colstart,
        rowstart; // some displays need this changed
#elif defined(__arm__)
    volatile RwReg *dataport, *clkport, *csport, *rsport;
    uint32_t _cs, _rs, _sid, _sclk, datapinmask, clkpinmask, cspinmask, rspinmask, colstart,
        rowstart; // some displays need this changed
